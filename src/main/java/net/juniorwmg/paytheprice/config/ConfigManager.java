...
public class ConfigManager {
    ...
    public static void PayThePriceConfig() {
        ...
        doNotShowModdedBrandingAtAll = config.getBoolean("Do not show any modified branding at all", "Other", false, "Setting this to true will remove all modded branding text from the main menu. This includes Forge version, mod count, information added by other mods like this poone and f.e. VintageFix etc.");
